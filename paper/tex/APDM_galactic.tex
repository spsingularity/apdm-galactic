...
\title[MOND as a rate-branch scale $a_0 \propto H(z)$]{The Galactic Face
of the Entropy Clock: MOND as a Rate-Branch Acceleration Scale a\(_{0}\)
\(\propto\) H(z)}
...
\begin{keywords}
modified Newtonian dynamics; galaxy rotation curves; dark energy;
emergent gravity; radial acceleration relation
\end{keywords}
